...
${OBJECTDIR}/BspProp.o: BspProp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspProp.o BspProp.cpp

${OBJECTDIR}/common/boundingbox.o: common/boundingbox.cpp 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/common/boundingbox.o common/boundingbox.cpp

${OBJECTDIR}/fs/File.o: fs/File.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/File.o fs/File.cpp
...
${OBJECTDIR}/RenderOptions.o: RenderOptions.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RenderOptions.o RenderOptions.cpp

${OBJECTDIR}/RenderMode.o: RenderMode.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/RenderMode.o RenderMode.cpp

${OBJECTDIR}/BspGeometry.o: BspGeometry.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspGeometry.o BspGeometry.cpp
...
${OBJECTDIR}/BspCollision.o: BspCollision.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspCollision.o BspCollision.cpp

${OBJECTDIR}/BspEntity.o: BspEntity.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspEntity.o BspEntity.cpp

${OBJECTDIR}/fs/FileSystemException.o: fs/FileSystemException.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/FileSystemException.o fs/FileSystemException.cpp
...
${OBJECTDIR}/fs/image/png.o: fs/image/png.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/image/png.o fs/image/png.cpp
...
${OBJECTDIR}/fs/image/bitmap.o: fs/image/bitmap.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/image
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/image/bitmap.o fs/image/bitmap.cpp

${OBJECTDIR}/fs/ZipPackage.o: fs/ZipPackage.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/ZipPackage.o fs/ZipPackage.cpp

${OBJECTDIR}/fs/FileSystem.o: fs/FileSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/FileSystem.o fs/FileSystem.cpp
...
${OBJECTDIR}/fs/image/jpeg.o: fs/image/jpeg.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/image
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/image/jpeg.o fs/image/jpeg.cpp
...
${OBJECTDIR}/HlBspData.o: HlBspData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HlBspData.o HlBspData.cpp

${OBJECTDIR}/fs/mesh/hlsdk/studio_render.o: fs/mesh/hlsdk/studio_render.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/mesh/hlsdk
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/mesh/hlsdk/studio_render.o fs/mesh/hlsdk/studio_render.cpp

${OBJECTDIR}/fs/image/targa.o: fs/image/targa.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/image
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/image/targa.o fs/image/targa.cpp
...
${OBJECTDIR}/fs/Resource.o: fs/Resource.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/Resource.o fs/Resource.cpp

${OBJECTDIR}/BspLoader.o: BspLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspLoader.o BspLoader.cpp

${OBJECTDIR}/HlBspWorld.o: HlBspWorld.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/HlBspWorld.o HlBspWorld.cpp
...
${OBJECTDIR}/Q3BspData.o: Q3BspData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Q3BspData.o Q3BspData.cpp
...
${OBJECTDIR}/Q3BspWorld.o: Q3BspWorld.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Q3BspWorld.o Q3BspWorld.cpp

${OBJECTDIR}/fs/mesh/Mesh.o: fs/mesh/Mesh.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/mesh
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/mesh/Mesh.o fs/mesh/Mesh.cpp

${OBJECTDIR}/FreeTypeFont.o: FreeTypeFont.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/FreeTypeFont.o FreeTypeFont.cpp

${OBJECTDIR}/fs/image/texture.o: fs/image/texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/image
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/image/texture.o fs/image/texture.cpp

${OBJECTDIR}/common/thread.o: common/thread.cpp 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/common/thread.o common/thread.cpp

${OBJECTDIR}/fs/mesh/hlsdk/studio_utils.o: fs/mesh/hlsdk/studio_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/mesh/hlsdk
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/mesh/hlsdk/studio_utils.o fs/mesh/hlsdk/studio_utils.cpp
...
${OBJECTDIR}/fs/mesh/Mdl.o: fs/mesh/Mdl.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/mesh
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/mesh/Mdl.o fs/mesh/Mdl.cpp

${OBJECTDIR}/common/common.o: common/common.cpp 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/common/common.o common/common.cpp
...
${OBJECTDIR}/fs/Package.o: fs/Package.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/Package.o fs/Package.cpp

${OBJECTDIR}/fs/WadPackage.o: fs/WadPackage.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/WadPackage.o fs/WadPackage.cpp

${OBJECTDIR}/fs/image/miptex.o: fs/image/miptex.cpp 
	${MKDIR} -p ${OBJECTDIR}/fs/image
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/fs/image/miptex.o fs/image/miptex.cpp

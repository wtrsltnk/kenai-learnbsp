...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/libbspplugin.a

dist/Debug/GNU-Linux-x86/libbspplugin.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${RM} dist/Debug/GNU-Linux-x86/libbspplugin.a
	${AR} rv ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libbspplugin.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/GNU-Linux-x86/libbspplugin.a

${OBJECTDIR}/BspPluginContext.o: nbproject/Makefile-${CND_CONF}.mk BspPluginContext.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspPluginContext.o BspPluginContext.cpp

${OBJECTDIR}/BspPlugin.o: nbproject/Makefile-${CND_CONF}.mk BspPlugin.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/BspPlugin.o BspPlugin.cpp
